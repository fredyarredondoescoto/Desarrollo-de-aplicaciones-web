...
<body>
   ...
   <div class="caja">
    ...
    <div class="contenedor">
        ...
        <div class="slider">
          ...
          <div class="contenido">
                   ...
                   <h1>Galería de imágenes HACKATON 2016</h1>
    
    <ul class="galeria">
        <li><a href="#img1"><img src="img/img1.jpg"></a></li>
        <li><a href="#img2"><img src="img/img2.jpg"></a></li>
        <li><a href="#img3"><img src="img/img3.jpg"></a></li>
        <li><a href="#img4"><img src="img/img4.jpg"></a></li>
        <li><a href="#img5"><img src="img/img5.jpg"></a></li>
        <li><a href="#img6"><img src="img/img6.jpg"></a></li>
        <li><a href="#img7"><img src="img/img7.jpg"></a></li>
        <li><a href="#img8"><img src="img/img8.jpg"></a></li>
        <li><a href="#img9"><img src="img/img9.jpg"></a></li>
        <li><a href="#img10"><img src="img/img10.jpg"></a></li>
        <li><a href="#img11"><img src="img/img11.jpg"></a></li>
        <li><a href="#img12"><img src="img/img12.jpg"></a></li>
        <li><a href="#img13"><img src="img/img13.jpg"></a></li>
        <li><a href="#img14"><img src="img/img14.jpg"></a></li>
        <li><a href="#img15"><img src="img/img15.jpg"></a></li>
        <li><a href="#img16"><img src="img/img16.jpg"></a></li>
    </ul>
    ...
    <div class="modal" id="img2">
        ...
        <div class="imagen">
            <a href="#img1">&#60;</a>
            <a href="#img3"><img src="img/img2.jpg"></a>
            <a href="#img3">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img3">
        ...
        <div class="imagen">
            <a href="#img2">&#60;</a>
            <a href="#img4"><img src="img/img3.jpg"></a>
            <a href="#img4">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img4">
        <h3>La ultima antes de comenzar</h3>
        <div class="imagen">
            <a href="#img3">&#60;</a>
            <a href="#img5"><img src="img/img4.jpg"></a>
            <a href="#img5">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img5">
        <h3>Llegada a HACKATON</h3>
        <div class="imagen">
            <a href="#img4">&#60;</a>
            <a href="#img6"><img src="img/img5.jpg"></a>
            <a href="#img6">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img6">
        ...
        <div class="imagen">
            <a href="#img5">&#60;</a>
            <a href="#img7"><img src="img/img6.jpg"></a>
            <a href="#img7">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img7">
        ...
        <div class="imagen">
            <a href="#img6">&#60;</a>
            <a href="#img8"><img src="img/img7.jpg"></a>
            <a href="#img8">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img8">
        ...
        <div class="imagen">
            <a href="#img7">&#60;</a>
            <a href="#img9"><img src="img/img8.jpg"></a>
            <a href="#img9">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>  
    ...
    <div class="modal" id="img9">
        ...
        <div class="imagen">
            <a href="#img8">&#60;</a>
            <a href="#img10"><img src="img/img9.jpg"></a>
            <a href="#img10">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>           
    ...
    <div class="modal" id="img10">
        ...
        <div class="imagen">
            <a href="#img9">&#60;</a>
            <a href="#img11"><img src="img/img10.jpg"></a>
            <a href="#img11">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img11">
        ...
        <div class="imagen">
            <a href="#img10">&#60;</a>
            <a href="#img12"><img src="img/img11.jpg"></a>
            <a href="#img12">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img12">
        ...
        <div class="imagen">
            <a href="#img11">&#60;</a>
            <a href="#img13"><img src="img/img12.jpg"></a>
            <a href="#img13">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img13">
        ...
        <div class="imagen">
            <a href="#img12">&#60;</a>
            <a href="#img14"><img src="img/img13.jpg"></a>
            <a href="#img14">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img14">
        ...
        <div class="imagen">
            <a href="#img13">&#60;</a>
            <a href="#img15"><img src="img/img14.jpg"></a>
            <a href="#img15">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
        ...
        <div class="imagen">
            <a href="#img14">&#60;</a>
            <a href="#img16"><img src="img/img15.jpg"></a>
            <a href="#img16">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
    ...
    <div class="modal" id="img16">
        ...
        <div class="imagen">
            <a href="#img15">&#60;</a>
            <a href="#img1"><img src="img/img16.jpg"></a>
            <a href="#img1">></a>
        </div>
        <a class="cerrar" href="">X</a>
    </div>
          ...
          <div class="destacados">
             <!-- <table>
                <tr>
                    <td>
                        <img src="img/fredy_1.jpg" alt="FREDY">
                    </td>
                </tr>
                
                <tr>
                    <td>Esta página es administrada por José Alfredo Arredondo Escoto, estudiante de TIC del grupo 3B
                    de la Universidad Tecnológica del Suroeste de Guanajuato.</td>
                </tr>
            </table> -->  
            
            <article id="tablaU">
               <h3>Usuarios registrados en la BD</h3>
                <?php
                    ...
                    $tblusuarios = $tblusuarios."<input type='submit' id='btndelate' value='Eliminar'>";   
                
                    if(sizeof($dsUsers) > 0){
                        foreach ($dsUsers as $usuario){
                            $tblusuarios = $tblusuarios."<tr>";
                            
                            $tblusuarios = $tblusuarios."<td>"."<input type='checkbox' id='usrcheck'>".$usuario->getId()."</td>";
                            $tblusuarios = $tblusuarios."<td>"."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$usuario->getUsername()."</td>";
                            $tblusuarios = $tblusuarios."<td>"."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='checkbox' id='actcheck'>"."</td>";
                            $tblusuarios = $tblusuarios."</tr>";
                        }
                    } else {
                        $tblusuarios = $tblusuarios."<tr>";
